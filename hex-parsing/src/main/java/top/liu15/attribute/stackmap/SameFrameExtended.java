...
public final class SameFrameExtended extends StackMapFrame {
    ...
    public SameFrameExtended(int previous, U1 value) {
    ...
    public void readDescription(ByteReader reader) {
        ...
        super.setDescription(String.format("SAME_FRAME_EXTENDED(%d),Offset:%d(+%d)", super.sameFrame.getValue().intValue(), super.previous + super.offsetLength, super.offsetLength));
    }
}
