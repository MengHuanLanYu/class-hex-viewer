...
public enum AccessFlag {
    ...
    ACC_SYNTHETIC(0x1000, "synthetic", String.format("%s,%s,%s,%s", ComponentType.T_CLASS, ComponentType.T_FILED, ComponentType.T_METHOD, ComponentType.T_INTERNAL_INTERFACE)),
